package pro.mobiledev.musictube.service
...
import pro.mobiledev.innertube.models.bodies.PlayerBody
import pro.mobiledev.innertube.requests.player
import pro.mobiledev.musictube.Database
import pro.mobiledev.musictube.MainActivity
import pro.mobiledev.musictube.R
import pro.mobiledev.musictube.enums.ExoPlayerDiskCacheMaxSize
import pro.mobiledev.musictube.models.Event
import pro.mobiledev.musictube.models.QueuedMediaItem
import pro.mobiledev.musictube.query
import pro.mobiledev.musictube.utils.InvincibleService
import pro.mobiledev.musictube.utils.RingBuffer
import pro.mobiledev.musictube.utils.TimerJob
import pro.mobiledev.musictube.utils.YouTubeRadio
import pro.mobiledev.musictube.utils.activityPendingIntent
import pro.mobiledev.musictube.utils.broadCastPendingIntent
import pro.mobiledev.musictube.utils.exoPlayerDiskCacheMaxSizeKey
import pro.mobiledev.musictube.utils.findNextMediaItemById
import pro.mobiledev.musictube.utils.forcePlayFromBeginning
import pro.mobiledev.musictube.utils.forceSeekToNext
import pro.mobiledev.musictube.utils.forceSeekToPrevious
...
import pro.mobiledev.musictube.utils.isInvincibilityEnabledKey
import pro.mobiledev.musictube.utils.isShowingThumbnailInLockscreenKey
import pro.mobiledev.musictube.utils.mediaItems
import pro.mobiledev.musictube.utils.persistentQueueKey
import pro.mobiledev.musictube.utils.preferences
import pro.mobiledev.musictube.utils.queueLoopEnabledKey
import pro.mobiledev.musictube.utils.resumePlaybackWhenDeviceConnectedKey
import pro.mobiledev.musictube.utils.shouldBePlaying
import pro.mobiledev.musictube.utils.skipSilenceKey
import pro.mobiledev.musictube.utils.timer
import pro.mobiledev.musictube.utils.trackLoopEnabledKey
import pro.mobiledev.musictube.utils.volumeNormalizationKey
...
class PlayerService : InvincibleService(), Player.Listener, PlaybackStatsListener.Callback,
                            ...
                            when (val status = body.playabilityStatus?.status) {
                                "OK" -> body.streamingData?.highestQualityFormat?.let { format ->
                                    ...
                                    query {
                                        ...
                                        Database.insert(
                                            pro.mobiledev.musictube.models.Format(
                                                songId = videoId,
                                                itag = format.itag,
    ...
    private value class Action(val value: String) {
        ...
        companion object {
            val pause = Action("pro.mobiledev.musictube.pause")
            val play = Action("pro.mobiledev.musictube.play")
            val next = Action("pro.mobiledev.musictube.next")
            val previous = Action("pro.mobiledev.musictube.previous")
        }
    }
